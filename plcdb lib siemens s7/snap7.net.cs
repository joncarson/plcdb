...
namespace Snap7
{
    ...
    public class S7Consts
    {
        ...
        //                                  PARAMS LIST            
        //------------------------------------------------------------------------------
        public const Int32 p_u16_LocalPort     = 1;
        ...
        public const Int32 p_i32_WorkInterval  = 6;
        public const Int32 p_u16_SrcRef        = 7;
        public const Int32 p_u16_DstRef        = 8;
        public const Int32 p_u16_SrcTSap       = 9;
        public const Int32 p_i32_PDURequest    = 10;
        public const Int32 p_i32_MaxClients    = 11;
        public const Int32 p_i32_BSendTimeout  = 12;
        public const Int32 p_i32_BRecvTimeout  = 13;
        public const Int32 p_u32_RecoveryTime  = 14;
        public const Int32 p_u32_KeepAliveTime = 15;
    }
    ...
    public class S7Client
    {
        ...
        // Error codes
        public const uint errNegotiatingPDU            = 0x00100000;
        public const uint errCliInvalidParams          = 0x00200000;
        public const uint errCliJobPending             = 0x00300000;
        public const uint errCliTooManyItems           = 0x00400000;
        public const uint errCliInvalidWordLen         = 0x00500000;
        public const uint errCliPartialDataWritten     = 0x00600000;
        public const uint errCliSizeOverPDU            = 0x00700000;
        public const uint errCliInvalidPlcAnswer       = 0x00800000;
        public const uint errCliAddressOutOfRange      = 0x00900000;
        public const uint errCliInvalidTransportSize   = 0x00A00000;
        public const uint errCliWriteDataSizeMismatch  = 0x00B00000;
        public const uint errCliItemNotAvailable       = 0x00C00000;
        public const uint errCliInvalidValue           = 0x00D00000;
        public const uint errCliCannotStartPLC         = 0x00E00000;
        public const uint errCliAlreadyRun             = 0x00F00000;
        public const uint errCliCannotStopPLC          = 0x01000000;
        public const uint errCliCannotCopyRamToRom     = 0x01100000;
        public const uint errCliCannotCompress         = 0x01200000;
        public const uint errCliAlreadyStop            = 0x01300000;
        public const uint errCliFunNotAvailable        = 0x01400000;
        public const uint errCliUploadSequenceFailed   = 0x01500000;
        public const uint errCliInvalidDataSizeRecvd   = 0x01600000;
        public const uint errCliInvalidBlockType       = 0x01700000;
        public const uint errCliInvalidBlockNumber     = 0x01800000;
        public const uint errCliInvalidBlockSize       = 0x01900000;
        public const uint errCliDownloadSequenceFailed = 0x01A00000;
        public const uint errCliInsertRefused          = 0x01B00000;
        public const uint errCliDeleteRefused          = 0x01C00000;
        public const uint errCliNeedPassword           = 0x01D00000;
        public const uint errCliInvalidPassword        = 0x01E00000;
        public const uint errCliNoPasswordToSetOrClear = 0x01F00000;
        public const uint errCliJobTimeout             = 0x02000000;
        public const uint errCliPartialDataRead        = 0x02100000;
        public const uint errCliBufferTooSmall         = 0x02200000;
        public const uint errCliFunctionRefused        = 0x02300000;
        public const uint errCliDestroying             = 0x02400000;
        public const uint errCliInvalidParamNumber     = 0x02500000;
        public const uint errCliCannotChangeParam      = 0x02600000;
        ...
        // Block type
        public const byte Block_OB  = 0x38;
        public const byte Block_DB  = 0x41;
        public const byte Block_SDB = 0x42;
        public const byte Block_FC  = 0x43;
        public const byte Block_SFC = 0x44;
        public const byte Block_FB  = 0x45;
        public const byte Block_SFB = 0x46;
        ...
        public const int MaxVars = 20;

        // Client Connection Type
        public const UInt16 CONNTYPE_PG    = 0x01;  // Connect to the PLC as a PG
        public const UInt16 CONNTYPE_OP    = 0x02;  // Connect to the PLC as an OP
        public const UInt16 CONNTYPE_BASIC = 0x03;  // Basic connection 
    ...
    public class S7Server
    {
        ...
        public const int srvAreaPE = 0;
        public const int srvAreaPA = 1;
        public const int srvAreaMK = 2;
        public const int srvAreaCT = 3;
        public const int srvAreaTM = 4;
        public const int srvAreaDB = 5;
        // Errors
        public const uint errSrvCannotStart        = 0x00100000; // Server cannot start
        public const uint errSrvDBNullPointer      = 0x00200000; // Passed null as PData
        public const uint errSrvAreaAlreadyExists  = 0x00300000; // Area Re-registration
        public const uint errSrvUnknownArea        = 0x00400000; // Unknown area
        public const uint errSrvInvalidParams      = 0x00500000; // Invalid param(s) supplied
        public const uint errSrvTooManyDB          = 0x00600000; // Cannot register DB
        public const uint errSrvInvalidParamNumber = 0x00700000; // Invalid param (srv_get/set_param)
        public const uint errSrvCannotChangeParam  = 0x00800000; // Cannot change because running

        // TCP Server Event codes
        public const uint evcServerStarted       = 0x00000001;
        public const uint evcServerStopped       = 0x00000002;
        public const uint evcListenerCannotStart = 0x00000004;
        public const uint evcClientAdded         = 0x00000008;
        public const uint evcClientRejected      = 0x00000010;
        public const uint evcClientNoRoom        = 0x00000020;
        public const uint evcClientException     = 0x00000040;
        public const uint evcClientDisconnected  = 0x00000080;
        public const uint evcClientTerminated    = 0x00000100;
        public const uint evcClientsDropped      = 0x00000200;
        public const uint evcReserved_00000400   = 0x00000400; // actually unused
        public const uint evcReserved_00000800   = 0x00000800; // actually unused
        public const uint evcReserved_00001000   = 0x00001000; // actually unused
        public const uint evcReserved_00002000   = 0x00002000; // actually unused
        public const uint evcReserved_00004000   = 0x00004000; // actually unused
        public const uint evcReserved_00008000   = 0x00008000; // actually unused
        // S7 Server Event Code
        public const uint evcPDUincoming         = 0x00010000;
        public const uint evcDataRead            = 0x00020000;
        public const uint evcDataWrite           = 0x00040000;
        public const uint evcNegotiatePDU        = 0x00080000;
        public const uint evcReadSZL             = 0x00100000;
        public const uint evcClock               = 0x00200000;
        public const uint evcUpload              = 0x00400000;
        public const uint evcDownload            = 0x00800000;
        public const uint evcDirectory           = 0x01000000;
        public const uint evcSecurity            = 0x02000000;
        public const uint evcControl             = 0x04000000;
        public const uint evcReserved_08000000   = 0x08000000; // actually unused
        public const uint evcReserved_10000000   = 0x10000000; // actually unused
        public const uint evcReserved_20000000   = 0x20000000; // actually unused
        public const uint evcReserved_40000000   = 0x40000000; // actually unused
        public const uint evcReserved_80000000   = 0x80000000; // actually unused
        // Masks to enable/disable all events
        public const uint evcAll  = 0xFFFFFFFF;
        public const uint evcNone = 0x00000000;
        // Event SubCodes
        public const ushort evsUnknown       = 0x0000;
        public const ushort evsStartUpload   = 0x0001;
        public const ushort evsStartDownload = 0x0001;
        public const ushort evsGetBlockList  = 0x0001;
        public const ushort evsStartListBoT  = 0x0002;
        public const ushort evsListBoT       = 0x0003;
        public const ushort evsGetBlockInfo  = 0x0004;
        public const ushort evsGetClock      = 0x0001;
        public const ushort evsSetClock      = 0x0002;
        public const ushort evsSetPassword   = 0x0001;
        public const ushort evsClrPassword   = 0x0002;
        // Event Params : functions group
        public const ushort grProgrammer     = 0x0041;
        public const ushort grCyclicData     = 0x0042;
        public const ushort grBlocksInfo     = 0x0043;
        public const ushort grSZL            = 0x0044;
        public const ushort grPassword       = 0x0045;
        public const ushort grBSend          = 0x0046;
        public const ushort grClock          = 0x0047;
        public const ushort grSecurity       = 0x0045;
        // Event Params : control codes
        public const ushort CodeControlUnknown   = 0x0000;
        public const ushort CodeControlColdStart = 0x0001;
        public const ushort CodeControlWarmStart = 0x0002;
        public const ushort CodeControlStop      = 0x0003;
        public const ushort CodeControlCompress  = 0x0004;
        public const ushort CodeControlCpyRamRom = 0x0005;
        public const ushort CodeControlInsDel    = 0x0006;
        // Event Result
        public const ushort evrNoError = 0x0000;
        public const ushort evrFragmentRejected  = 0x0001;
        public const ushort evrMalformedPDU      = 0x0002;
        public const ushort evrSparseBytes       = 0x0003;
        public const ushort evrCannotHandlePDU   = 0x0004;
        public const ushort evrNotImplemented    = 0x0005;
        public const ushort evrErrException      = 0x0006;
        public const ushort evrErrAreaNotFound   = 0x0007;
        public const ushort evrErrOutOfRange     = 0x0008;
        public const ushort evrErrOverPDU        = 0x0009;
        public const ushort evrErrTransportSize  = 0x000A;
        public const ushort evrInvalidGroupUData = 0x000B;
        public const ushort evrInvalidSZL        = 0x000C;
        public const ushort evrDataSizeMismatch  = 0x000D;
        public const ushort evrCannotUpload      = 0x000E;
        public const ushort evrCannotDownload    = 0x000F;
        public const ushort evrUploadInvalidID   = 0x0010;
        public const ushort evrResNotFound       = 0x0011;
    ...
    public class S7Partner
    {
        ...
        // Status
        public const int par_stopped    = 0;   // stopped
        public const int par_connecting = 1;   // running and active connecting
        public const int par_waiting    = 2;   // running and waiting for a connection
        public const int par_linked     = 3;   // running and connected : linked
        public const int par_sending    = 4;   // sending data
        public const int par_receiving  = 5;   // receiving data
        public const int par_binderror  = 6;   // error starting passive server

        // Errors
        public const uint errParAddressInUse       = 0x00200000;
        public const uint errParNoRoom             = 0x00300000;
        public const uint errServerNoRoom          = 0x00400000;
        public const uint errParInvalidParams      = 0x00500000;
        public const uint errParNotLinked          = 0x00600000;
        public const uint errParBusy               = 0x00700000;
        public const uint errParFrameTimeout       = 0x00800000;
        public const uint errParInvalidPDU         = 0x00900000;
        public const uint errParSendTimeout        = 0x00A00000;
        public const uint errParRecvTimeout        = 0x00B00000;
        public const uint errParSendRefused        = 0x00C00000;
        public const uint errParNegotiatingPDU     = 0x00D00000;
        public const uint errParSendingBlock       = 0x00E00000;
        public const uint errParRecvingBlock       = 0x00F00000;
        public const uint errBindError             = 0x01000000;
        public const uint errParDestroying         = 0x01100000;
        public const uint errParInvalidParamNumber = 0x01200000; 
        public const uint errParCannotChangeParam  = 0x01300000; 
